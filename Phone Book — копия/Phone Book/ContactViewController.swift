...
class ContactViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate{
    ...
    @objc func createButtonPressed(_ sender: UIButton){
        if ContactTableView!.nameField.text != nil{
            ...
            let contact: Contact = Contact( name: ContactTableView!.nameField.text!, number: ContactTableView!.numberField.text ?? "", creationDate: Date())
    ...
    @objc func saveButtonPressed(_ sender: UIButton){
        controller!.updContact(Id: controller!.currentContactId , name: ContactTableView!.nameField.text , number : ContactTableView!.numberField.text, image: nil)
        viewMode = .view
        viewWillAppear(false)
    }
